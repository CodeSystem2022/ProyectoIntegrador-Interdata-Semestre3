...
class MenuCamisas:
    ...
    def menuCamisas(self, compraTotal, compraProductos):
        ...
        if modelo == 1:
            self.nombreModelo = "Camisa Hefei"
            self.precio = 30740
        elif modelo == 2:
            self.nombreModelo = "Camisa Pekin"
            self.precio = 25950
        elif modelo == 3:
            self.nombreModelo = "Camisa Canton"
            self.precio = 28580
        elif modelo == 4:
            self.nombreModelo = "Camisa Nankin"
            self.precio = 29000
        elif modelo == 5:
            self.nombreModelo = "Camisa Hangzhou"
            self.precio = 24050
        elif modelo == 6:
            self.nombreModelo = "Camisa Quanzhou"
            self.precio = 28200
        elif modelo == 7:
            self.salida = True
            llamada = Productos()
